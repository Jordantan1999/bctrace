 ...
 */
package bctrace.runtime.io.shiftleft.bctrace.runtime.listener.direct;
  ...
  private Method searchListenerMethod() {
    ...
    while (clazz != null) {
      ...
      for (Method declaredMethod : declaredMethods) {
        if (declaredMethod.getAnnotation(ListenerMethod.class) != null) {
          if (ret != null) {
            if (ret.getName().equals(declaredMethod.getName()) &&
                Arrays.equals(ret.getParameterTypes(), declaredMethod.getParameterTypes())) {
              continue;
            }
