package bctrace.core.io.shiftleft.bctrace.util;
...
public final class Utils {
  ...
  private static final Lookup unsafe = getPlatformUnsafe();
  ...
  private static Lookup getPlatformUnsafe() {
    try {
      ...
      return (Lookup) instanceField.get(null);
    } catch (Exception ex) {
      throw new Error(ex);
    }
  }
