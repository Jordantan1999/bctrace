 ...
 */
package bctrace.core.io.shiftleft.bctrace.hierarchy;
...
import bctrace.core.io.shiftleft.bctrace.Instrumentation;
...
public final class UnloadedClass extends BctraceClass {
  ...
  private static ClassNode createClassNode(final URL url) throws ClassNotFoundException, IOException {
    if (url == null) {
